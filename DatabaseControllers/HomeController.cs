...
{
    class HomeController : DatabaseController
    {
        public List<Artikel> GetWeekaanbiedingen()
        {
            ...
            try
            {
                ...
                string selectQuery = "SELECT * FROM Artikel a inner join Merk m on artikel_merk=merk_nummer WHERE artikel_weekaanbieding = '1' LIMIT 4";
